...
public sealed class OrderEvent
{
    ...
    [JsonPropertyName("warehouse_id")] public long WarehouseId { get; set; }

    [JsonPropertyName("status")] public OrderStatus Status { get; set; }

    [JsonPropertyName("moment")] public DateTime Moment { get; set; }

    [JsonPropertyName("positions")] public OrderEventPosition[] Positions { get; set; } = null!;
    ...
    public sealed class OrderEventPosition
    {
        ...
        [JsonPropertyName("price")] public Money Price { get; set; } = null!;
    }
    ...
    public sealed class Money
    {
        ...
        [JsonPropertyName("units")] public long Units { get; set; }
